            ...
            <div class="inner-container container">
                ...
                <div class="project-detail row">
                    <div class="project-slider col-md-12">
                        <img src="images/hiriketiya beach.jpg" alt="">
                    </div> <!-- /.project-slider -->
                    <div class="project-infos col-md-12">
                        <div class="box-content">
                            <h2 class="project-title">Hiriketiya beach</h2>
                            <p>Hiriketiya Beach is one of the places we had heard least about when we were planning our 3 week trip around Sri Lanka. I wouldn’t quite call it the hidden gem of the south coast, as it is growing in popularity, but it’s not too far off it. 
                            <br>The neighboring town, Dikwella (known locally as Dickwella), has become a huge draw to people visiting Sri Lanka’s south coast. The laid-back lifestyle and surf vibes at Hiriketiya Beach and Dikwella have created those amazing coastal towns we absolutely love.
                            </p>
