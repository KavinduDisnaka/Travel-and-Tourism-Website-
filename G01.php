            ...
            <div class="inner-container container">
                ...
                <div class="project-detail row">
                    <div class="project-slider col-md-12">
                        <img src="images/dalawella beach.jpg" alt="">
                        <a href="#" class="slidesjs-previous slidesjs-navigation">&lt;</a> 
                        <a href="#" class="slidesjs-next slidesjs-navigation">&gt;</a>
                    </div> <!-- /.project-slider -->
                    <div class="project-infos col-md-12">
                        <div class="box-content">
                            <h2 class="project-title">Dalawella Beach</h2>
                            <p>Dalawella beach is located on the south coast of Sri Lanka in the Unawatuna area and is one of the beautiful Sri Lanka beaches. 
                            ...
                            <ul class="project-meta">
                                ...
                                <li><i class="fa fa-envelope-o"></i><a href="mailto:info@company.com">hansishanee@gmail.com</a></li>
                            </ul>
                        </div> <!-- /.box-content -->
                    </div> <!-- /.project-infos -->
                </div> <!-- /.project-detail -->
